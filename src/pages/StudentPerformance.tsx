      ...
      achievementStats.some((m) => m.count > 0) && (
        <>
          ...
          {(() => {
            ...
            const getAchievementStars = (t: number) => {
              if (t >= 8) return 5;
              if (t >= 5) return 4;
              if (t >= 2) return 3;
              if (t === 1) return 2;
            ...
            const getAchievementReview = (t: number) => {
      ...
      contribStats.some(
        ...
        <>
          ...
          {(() => {
            ...
            const getContributionStars = (research: number, internship: number) => {
            ...
            const getContributionReview = (research: number, internship: number) => {
